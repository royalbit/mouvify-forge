...
1. **SR&ED Tax Credits** (Federal + Quebec CRIC)
   - **Value**: $100K-$300K+ annually (refundable)
   - **Timeline**: Apply with 2025 tax return
   - **Why**: Already documented in SRED_RESEARCH_LOG.md (1,400+ lines)

2. **NRC IRAP** (Industrial Research Assistance Program)
   - **Value**: $300K-$500K (75% of project costs)
   - **Timeline**: Apply now for 2025 funding
...
- **Rates**:
  - 30% on first $1M of eligible spending
  - 20% on spending above $1M
- **Fully Refundable**: YES (cash refund)
...
✅ Cloud computing costs (AWS, servers)
...
1. **Document During Development** (already doing this!)
   ...
   - Technical uncertainties documented
   - Hypotheses → experiments → results

2. **File with Tax Return**
   - Form T661 (Federal) + CO-17.A.1 (Quebec)
   - Include SRED_RESEARCH_LOG.md as supporting documentation
   - Timeline: File with 2025 corporate tax return (June 2026)

3. **Expected Value for 2025**
   - Conservative estimate: $200K R&D expenditures
   - Federal SR&ED: $70,000 refund
   - Quebec CRIC: $60,000 refund
...
2. **Prepare Proposal**
   ...
   - Budget breakdown
   - Expected outcomes
   - *Use SRED_RESEARCH_LOG.md as foundation*

3. **Timeline**
   - Initial contact: January 2026
   - Assessment: February 2026
   - Proposal submission: March 2026
   - Funding decision: April-May 2026
...
1. **Document 2025 R&D for SR&ED**
   - ✅ Already have 1,400+ lines in SRED_RESEARCH_LOG.md
   - Add Experiment 14 details (autonomous AI protocol)
   - Track all development time Nov-Dec 2025
   - File with 2025 tax return (June 2026)
   - **Expected**: $130K refund (Federal + Quebec)

2. **Apply for J. Armand Bombardier**
   - **Value**: $10,000
...
**Strategy**: Frame as "developed for our own internal needs, proven effective, now open sourcing for Canadian tech benefit"
...
1. **Prepare SR&ED Documentation**
   - Review SRED_RESEARCH_LOG.md completeness
   - Add any missing 2025 R&D activities
   - Calculate eligible expenditures
   - **Contact**: SR&ED consultant (e.g., Boast.ai, Ayming)

2. **Research J. Armand Bombardier Deadline**
   - Check application timeline for 2026
   - Prepare application materials
   - **Contact**: Quebec government innovation office
...
- Quebec location (provincial + municipal programs)

**This is not "maybe" money - these are legitimate programs where RoyalBit is a perfect fit.**

Start with SR&ED (already documented!) and NRC IRAP (highest value, best fit). Woman-owned grants are low-hanging fruit. Build from there.
